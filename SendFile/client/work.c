...
void send_file_info(int sock_fd, char *fname, struct stat* p_fstat, struct fileinfo *p_finfo, int *p_last_bs)
{	
	//initlize file_info
    ...
    //when the last data is not enough for a block
